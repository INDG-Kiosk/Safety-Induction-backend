    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Medical(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>30 Registered Medicals</span>
        </h3>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-140px'>Approval Status</th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a className='btn btn-sm btn-danger fw-bolder ms-2 fs-8 py-1 px-3'>Expired</a>
                </td>
                <td className=''>
                  <div className='d-flex justify-content-start flex-column'>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span className='text-muted fw-bold text-muted d-block fs-7'>Medical</span>
                </td>
                <td>
...
function MedicalAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={profileBreadCrumbs}>All Medicals</PageTitle>
      <MedicalAll />
    </>
  )
}

export default MedicalAllWrapper
