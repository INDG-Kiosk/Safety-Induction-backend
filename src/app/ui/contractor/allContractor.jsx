    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Contractor(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{data.length} Registered Contractors</span>
        </h3>
        ...
        <div>
          ...
          >
            <thead>
              ...
              <td className='text-gray-600 text-gray-800 fw-bolder'>Mail Address</td>
              ...
              {page.map((row, i) => {
                ...
                return (
                  <tr {...row.getRowProps()}>
                    ...
                    <td>{row.values.nameEN}</td>
                    <td>{row.values.mailingAddress}</td>
                    <td>
                      <input type='checkbox' readOnly checked={row.values.isActive} />
                    </td>
                    {user.role !== 'Content_Admin' && (
                      <td>
                        <a href={'/dashboard/contractor/' + row.values.code}>view guests</a>
                      </td>
                    )}
                    <td>
...
function ContractorAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>All Contractors</PageTitle>
...
export default ContractorAllWrapper
