    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted mt-1 fw-bold fs-7'>{data.length} Registered Questions</span>
        </h3>
      ...
      <div className='card-body py-3'>
        <div>
          ...
          >
            <thead>
              <td className='text-gray-600 text-gray-800 fw-bolder'>Question</td>
...
function ContractorAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>Question Bank</PageTitle>
