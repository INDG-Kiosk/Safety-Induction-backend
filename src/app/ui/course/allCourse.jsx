    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Course(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{data.length} Registered Course(s)</span>
        </h3>
      ...
      <div className='card-body py-3'>
        <div>
          ...
          >
            <thead>
              <td className='text-gray-600 text-gray-800 fw-bolder'>Title</td>
              <td className='text-gray-600 text-gray-800 fw-bolder'>Site</td>
              <td className='text-gray-600 text-gray-800 fw-bolder'>Location</td>
              <td className='text-gray-600 text-gray-800 fw-bolder'>Pass Rate</td>
              ...
              {page.map((row, i) => {
                ...
                return (
                  <tr {...row.getRowProps()}>
                    ...
                    <td>{row.values.passRate}</td>
                    <td>
                      <input type='checkbox' readOnly checked={row.values.isActive} />
                    </td>
                    <td>
                      <a href={'/course-question/map/' + row.values.code}>questions</a>
                    </td>
                    <td>
...
function CourseAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>All Courses</PageTitle>
...
export default CourseAllWrapper
