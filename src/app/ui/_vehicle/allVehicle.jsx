    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Vehicle(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>30 Registered Vehicles</span>
        </h3>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>Transporter</th>
                <th className='min-w-140px'>Type</th>
                <th className='min-w-140px'>Machine/Tailer No#</th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <span className='text-muted fw-bold text-muted d-block fs-7'>Vehicle Number</span>
                </td>
                <td>
...
function VehicleAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={profileBreadCrumbs}>All Vehicles</PageTitle>
      <VehicleAll />
    </>
  )
}

export default VehicleAllWrapper
