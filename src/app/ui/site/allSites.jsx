    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Site(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{data.length} Registered Sites</span>
        </h3>
              ...
              {page.map((row, i) => {
                ...
                return (
                  <tr {...row.getRowProps()}>
                    ...
                    <td>
                      <a href={'/dashboard/detail/' + row.values.code}>view attempts</a>
                    </td>
                    <td>
...
function SiteAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>All Sites</PageTitle>
