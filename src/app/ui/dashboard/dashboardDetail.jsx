...
function DashboardDetail(props) {
  ...
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>{state.siteName + ' Guest List'}</PageTitle>
          ...
          <div className='card-header border-0 pt-5'>
            <h3 className='card-title align-items-start flex-column'>
              ...
              <span className=' mt-1 fw-bold fs-7'>
                {data.length} Records | {state.totalRegistered} Registered | {state.totalVisitors}{' '}
                Visitors | {state.totalWorkers} Workers | {state.totalFails} Failed
              </span>
            </h3>
          </div>
          <div className='card-header border-0 pt-5'>
