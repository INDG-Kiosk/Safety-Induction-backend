    ...
    <div className={`card`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>All Records(s)</span>
          <span className='text-muted mt-1 fw-bold fs-7'>30+ Records Available</span>
        </h3>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-140px'>Driver</th>
                <th className='min-w-140px'>Helper</th>
...
function MonitorAllWrapper() {
  return (
    <>
      <PageTitle breadcrumbs={profileBreadCrumbs}>All Daily Monitor Records</PageTitle>
      <MonitorAll />
    </>
  )
}

export default MonitorAllWrapper
